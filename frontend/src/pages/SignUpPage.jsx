...
import { Eye, EyeOff, LoaderCircle, Lock, Mail, MessageSquare, User } from 'lucide-react'
import { Link } from 'react-router-dom'
import CreateImagePattern from '../components/CreateImagePattern.jsx'
  ...
  return (
    <div className='min-h-screen grid lg:grid-cols-2 font-inter'>
      ...
      <CreateImagePattern 
        ...
        subtitle='Connect with friends, share moments, and enjoy'
      />
    </div>
  )
}
